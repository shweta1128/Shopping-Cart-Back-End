...
public class ApplicationController {
    ...
    public void displayMainMenu() {
        ...
        console.printMessage("Welcome to the Nation Parks application.");
            ...
            if (selection.equals(SELECT)) {
                ...
                if (currentPark != null) {
                    ...
                    if (updatedPark != null) {
                        ...
                        if (parkDao.updatePark(updatedPark)) {
                            console.printBlankLine();
                ...
                if (currentPark != null) {
                    if (view.deletePark(currentPark)) {
                        ...
                        parkDao.deletePark(currentPark.getParkId());
                        console.printBlankLine();
            ...
            if (selection.equals(SELECT)) {
                ...
                if (currentCampground != null) {
                    ...
                    if (updatedCampground != null) {
                        // Update park, display success and make it current if updated successfully
                        if (campgroundDao.updateCampground(updatedCampground)) {
                            console.printBlankLine();
                ...
                if (currentCampground != null) {
                    if (view.deleteCampground(currentCampground)) {
                        ...
                        campgroundDao.deleteCampground(currentCampground.getCampgroundId());
                        console.printBlankLine();
