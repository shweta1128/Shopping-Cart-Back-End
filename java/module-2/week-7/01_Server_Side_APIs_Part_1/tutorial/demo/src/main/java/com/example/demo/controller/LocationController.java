...
public class LocationController {
    ...
    public Location getLocations(@PathVariable int id) { //@PathVariable covered later in unit
           for(Location locationForId : locations){
               if(locationForId.getId() == id ){
                   location = locationForId;
               }
           }
