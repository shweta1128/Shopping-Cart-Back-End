...
//		}
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
		ArrayList<Double> int2Double = new ArrayList<Double>();


		for (int i = 0; i < intArray.length; i++) {
			int A = 2;
			int2Double.add((double) intArray[i] / A);
	...
	public Integer findLargest(List<Integer> integerList) {
		...
		//List<Integer> maxNumber = new ArrayList<>(integerList.size());
	...
	//	int odd = 0;
		List<Integer> oddNumbers = new ArrayList<>(integerArray.length);
	...
	public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
		...
		if (listOne.size() <= listTwo.size()) {
			...
			for (int i = 0; i < listOne.size(); i++) {
             ...
             return interList;
		//return Collections.singletonList(together);
	}
}
