...
public class AssessmentPart1 {
	...
	*/
	public String Q06_firstNCharacters(String originalString, int numCharacters) {
		...
		if (numCharacters == 0) {
           return "";
		} else if (numCharacters > 0 && numCharacters > originalString.length()) {

			return originalString;
		}
		return originalString.substring(0, 3);
	}
	...
	*/
	public int[] Q10_swapFirstAndLastElements(int[] arrayOfInts) {
		...
		int elementsOfArray = arrayOfInts[arrayOfInts.length-1];
		//arrayOfInts[0] = elementsOfArray;
        arrayOfInts[arrayOfInts.length-1] = arrayOfInts[0];
		arrayOfInts[0] = elementsOfArray;
		return arrayOfInts;
