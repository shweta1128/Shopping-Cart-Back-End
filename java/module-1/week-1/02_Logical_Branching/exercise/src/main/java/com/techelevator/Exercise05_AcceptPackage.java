...
public class Exercise05_AcceptPackage {
    ...
    public boolean acceptPackage(int weightPounds, int lengthInches, int widthInches, int heightInches) {
        double total = lengthInches * widthInches * heightInches;


        if (weightPounds <= MAX_WEIGHT_POUNDS && total <= MAX_CUBIC_INCHES) {
    ...
    public boolean acceptPackage(int weightPounds, int lengthInches, int widthInches, int heightInches,
        ...
        if (weightPounds <= MAX_WEIGHT_POUNDS && total <= MAX_CUBIC_INCHES) {
            ...
            } else if (isSurchargePaid && (lengthInches > MAX_DIMENSION_INCHES || widthInches > MAX_DIMENSION_INCHES || heightInches > MAX_DIMENSION_INCHES)) {
                return true;
