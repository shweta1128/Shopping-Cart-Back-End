...
public class Exercise07_StoreHours {
    ...
    public boolean isStoreOpen(int currentHour, char currentDay) {
        ...
        if (currentHour >= 8 && currentHour < 17 && currentDay == Monday) {
            return true;
        }

        if (currentHour >= 8 && currentHour < 17 && currentDay == Wednesday) {
            return true;

        } else if (currentHour >= 8 && currentHour < 17 && currentDay == Friday) {
            return true;
        }
    ...
    public boolean isStoreOpen(int currentHour, char currentDay, boolean isSummer) {
        ...
        if (isSummer) {
            ...
            if (currentHour >= 8 && currentHour < 20 && currentDay == Wednesday) {
                return true;
            } else if (currentHour >= 9 && currentHour < 15 && currentDay == Saturday) {
                return true;
            } else if (currentHour >= 8 && currentHour < 17 && currentDay == Monday) {
                return true;
            } else if (currentHour >= 8 && currentHour < 17 && currentDay == Friday) {
                return true;
            }
