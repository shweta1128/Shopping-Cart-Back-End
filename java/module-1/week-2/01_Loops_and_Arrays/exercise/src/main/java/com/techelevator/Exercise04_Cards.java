...
public class    Exercise04_Cards {
    ...
    */
    ...
    public String[] discardFirstCard(String[] hand) {
        String [] eliminateFirstCard = new String [4];
//        eliminateFirstCard[0] = hand [1];
//        eliminateFirstCard[1] = hand [2];
//        eliminateFirstCard[2] = hand [3];
//        eliminateFirstCard[3] = hand [4];
        for ( int i = 0; i < hand.length -1; i ++) {
           eliminateFirstCard[i] = hand[i + 1];

        }
        return eliminateFirstCard;
    }
    ...
    public String[] discardTopCard(String[] remainingDeck) {
        String[] discardFirstCard;
        String [] topCard = new String[0];
        if (remainingDeck.length > 1) {
            discardFirstCard = new String[remainingDeck.length - 1];


            for (int i = 1; i < remainingDeck.length ; i++) {

                discardFirstCard[i - 1] = remainingDeck[i];
            }


            return discardFirstCard;
        } else {
            return topCard;
        }
    }
