...
public class Exercises {
	...
	public String theEnd(String str, boolean front) {
		//String [] myString = new String[str.length()];
	...
	public boolean endsLy(String str) {;
		...
		String ends = str.substring(str.length()-2 , str.length());
           return ends.equalsIgnoreCase("ly");
	...
	public String twoChar(String str, int n) {
		if ( n < 0 || n+2 > str.length()) {
          ...
          String last = str.substring(n, n+2);
			return last;
	...
	public String middleThree(String str) {
		...
		String middleChars = str.substring(str.length()/2 - 1, str.length()/2 + 2);
		return middleChars;
	}
	...
	public boolean hasBad(String str) {
		if (str.equalsIgnoreCase("bad")) {
			return true;
		} else if (str.length() <= 3 && !str.equalsIgnoreCase("bad")) {
			return false;
		}
		String firstBad = str.substring(0, 3);
		String secondBad = str.substring(1, 4);
		if (firstBad.equalsIgnoreCase("bad") || secondBad.equalsIgnoreCase("bad")) {
			return true;
		}
 ...
 return counter;
	...
	public String frontTimes(String str, int n) {
		...
		for (int i =0; i < n; i++){
			...
			} else if (str.length() >3 && i <= str.length()) {
	...
	int count = 0;
		...
		for (int i = 0; i < str.length()-1; i ++){
			String firstChar = str.substring(i, i+2);
				if (firstChar.equalsIgnoreCase("xx")){
					count ++;
				}
			}
	...
	public boolean doubleX(String str) {
		for (int i =0; i < str.length(); i++){
			int letterX = str.indexOf("x");
			if (letterX == -1) {
				return false;

		} else if (letterX >= str.length()-1){
				return false;

			} else if (str.substring(letterX, letterX + 2) .equalsIgnoreCase("xx")){
				return true;
			}
