...
public class Example1 {
    ...
    /*
     1. Given a starting number and a higher ending number, return the sum of all
     the numbers from the starting number up to the ending number.
    ...
    */
    ...
    /*
	 2. Given an array of ints, return true if one of the first 4 elements
